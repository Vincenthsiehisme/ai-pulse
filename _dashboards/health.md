...
probe_lag_days: 0
last_run_day: "2026-09-09"
run_lag_days: 0
stale_after_days: 2
sources_runnable: 28
items_observed: 2991
events_total: 296
events_published: 234
---
...
> 這頁自己就是死人開關：鏈沒跑就沒人重寫它，`generated_day` 會停在 2026-09-09 不動。所以先看那個日期是不是今天，再看下面的燈。
...
| 已觀測 | 累計 2991 筆，來自 25 條來源 | 這裡是**歷來**累計，含現在已停用的來源，所以不能直接跟上一格相減。本窗口誰零產出看下面「覆蓋範圍」那一節 |
| 有效產出 | 296 則事件 | 抓到了但沒聚成事件＝聚類沒認出來 |
| 已發布 | 234 則 | 卡在門禁是設計，不是故障 |

## 鏈的兩條時間軸

| | 最後一次 | 距今 | 這條停了代表什麼 |
|---|---|---|---|
| 有跑班（`_probe/`） | 2026-09-09 | 0 天 | 排程死了 |
| 有抓到東西（`_corpus/`） | 2026-09-09 | 0 天 | 鏈在跑但瞎了（來源全壞、或全站沒更新） |

「靜默死掉」與「靜默瞎掉」是兩種病，所以兩條軸分開印。2026-07-24 漏抓 Claude Opus 5 的那晚，上面那條是綠的。

## 佇列

- 已上線 **234**／review **60**（待處理 45、設計上擋著 15）／人工判定不追 **2**
- 未 enrich **23** 則，最久放了 **46** 天
- 待處理卡最久 **46** 天（天數＝**進庫**多久，不是新聞發布多久）

| blocker | 則數 |
|---|---|
| `placeholder_content` | 23 |
| `missing_category` | 23 |
| `missing_track` | 23 |
| `thin_by_policy` | 22 |
...
|---|---|---|---|---|---|
| OpenAI | 2 | 1304 | 57 | 53 | 0d 前 |
| Anthropic | 1 | 500 | 44 | 34 | 0d 前 |
| Google DeepMind | 1 | 191 | 11 | 10 | 0d 前 |
| Google | 1 | 498 | 11 | 10 | 0d 前 |
| Meta | 1 | 274 | 1 | 1 | 0d 前 |
| Microsoft | 1 | 149 | 2 | 2 | 0d 前 |
| NVIDIA | 1 | 515 | 22 | 19 | 0d 前 |
| Hugging Face | 1 | 197 | 13 | 8 | 0d 前 |
| xAI | 1 | 15 | 8 | 8 | 1d 前 |
| Mistral AI | 1 | 3 | 0 | 0 | 1d 前 |
| Alibaba | 1 | 9 | 0 | 0 | 16d 前 |
| DeepSeek | 0 | 266 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Safe Superintelligence | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Thinking Machines Lab | 0 | 3 | 0 | 0 | 10d 前 ○ 已知未覆蓋（不觸警） |
| Cohere | 0 | 30 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Perplexity | 0 | 5 | 0 | 0 | 7d 前 ○ 已知未覆蓋（不觸警） |
| Anysphere (Cursor) | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Cognition | 0 | 7 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Scale AI | 0 | 265 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Z.ai | 0 | 7 | 0 | 0 | 12d 前 ○ 已知未覆蓋（不觸警） |
| Moonshot AI | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| MiniMax | 0 | 59 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| ByteDance | 0 | 9 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Baidu | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Tencent | 0 | 7 | 0 | 0 | 4d 前 ○ 已知未覆蓋（不觸警） |
| AMD | 1 | 56 | 0 | 0 | 0d 前 |
| TSMC | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Broadcom | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Groq | 0 | 18 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Cerebras | 0 | 28 | 0 | 0 | 1d 前 ○ 已知未覆蓋（不觸警） |
| CoreWeave | 0 | 1 | 0 | 0 | 30d 前 ○ 已知未覆蓋（不觸警） |
...
- ⚠ 潤稿鏈：最後一次推回 2026-09-07（2 天前），**超過門檻 2 天**——那一邊做完了推不上來，它自己叫不出聲
...
- 判斷層帳本：168 筆，最近一次 2026-09-08（1 天前）；最近 7 天有 6 條主線改過主張（agent-refactor、capital-evolution、global-map、infra-cost、model-research、product-market）
