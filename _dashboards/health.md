...
status: "green"
last_success: "2026-08-30"
probe_lag_days: 0
last_run_day: "2026-08-30"
run_lag_days: 0
stale_after_days: 2
sources_runnable: 28
items_observed: 2385
...
> 這頁自己就是死人開關：鏈沒跑就沒人重寫它，`generated_day` 會停在 2026-08-30 不動。所以先看那個日期是不是今天，再看下面的燈。
...
| 已觀測 | 累計 2385 筆，來自 25 條來源 | 這裡是**歷來**累計，含現在已停用的來源，所以不能直接跟上一格相減。本窗口誰零產出看下面「覆蓋範圍」那一節 |
...
| | 最後一次 | 距今 | 這條停了代表什麼 |
|---|---|---|---|
| 有跑班（`_probe/`） | 2026-08-30 | 0 天 | 排程死了 |
| 有抓到東西（`_corpus/`） | 2026-08-30 | 0 天 | 鏈在跑但瞎了（來源全壞、或全站沒更新） |

「靜默死掉」與「靜默瞎掉」是兩種病，所以兩條軸分開印。2026-07-24 漏抓 Claude Opus 5 的那晚，上面那條是綠的。

## 佇列

- 已上線 **198**／review **28**（待處理 13、設計上擋著 15）／人工判定不追 **2**
...
|---|---|---|---|---|---|
| OpenAI | 2 | 1114 | 51 | 50 | 0d 前 |
| Anthropic | 1 | 385 | 31 | 30 | 0d 前 |
| Google DeepMind | 1 | 172 | 6 | 5 | 0d 前 |
| Google | 1 | 492 | 6 | 5 | 0d 前 |
| Meta | 1 | 215 | 1 | 1 | 0d 前 |
| Microsoft | 1 | 144 | 2 | 2 | 0d 前 |
| NVIDIA | 1 | 421 | 24 | 23 | 0d 前 |
| Hugging Face | 1 | 147 | 9 | 5 | 0d 前 |
| xAI | 1 | 20 | 7 | 6 | 0d 前 |
| Mistral AI | 1 | 1 | 0 | 0 | 20d 前 |
| Alibaba | 1 | 11 | 0 | 0 | 6d 前 |
| DeepSeek | 0 | 247 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Safe Superintelligence | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Thinking Machines Lab | 0 | 3 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Cohere | 0 | 26 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Perplexity | 0 | 8 | 0 | 0 | 11d 前 ○ 已知未覆蓋（不觸警） |
| Anysphere (Cursor) | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Cognition | 0 | 6 | 0 | 0 | 9d 前 ○ 已知未覆蓋（不觸警） |
| Scale AI | 0 | 233 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Z.ai | 0 | 8 | 0 | 0 | 2d 前 ○ 已知未覆蓋（不觸警） |
| Moonshot AI | 0 | 1 | 0 | 0 | 27d 前 ○ 已知未覆蓋（不觸警） |
| MiniMax | 0 | 58 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| ByteDance | 0 | 8 | 0 | 0 | 13d 前 ○ 已知未覆蓋（不觸警） |
| Baidu | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Tencent | 0 | 1 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| AMD | 1 | 40 | 0 | 0 | 0d 前 |
| TSMC | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Broadcom | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Groq | 0 | 8 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Cerebras | 0 | 17 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| CoreWeave | 0 | 7 | 0 | 0 | 20d 前 ○ 已知未覆蓋（不觸警） |
| AWS | 0 | 65 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
...
- 判斷層帳本：128 筆，最近一次 2026-08-29（1 天前）；最近 7 天有 6 條主線改過主張（agent-refactor、capital-evolution、global-map、infra-cost、model-research、product-market）
