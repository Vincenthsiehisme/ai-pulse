...
status: "green"
last_success: "2026-08-11"
probe_lag_days: 0
last_run_day: "2026-08-11"
run_lag_days: 0
stale_after_days: 2
sources_runnable: 27
items_observed: 1341
...
> 這頁自己就是死人開關：鏈沒跑就沒人重寫它，`generated_day` 會停在 2026-08-11 不動。所以先看那個日期是不是今天，再看下面的燈。
...
| | 最後一次 | 距今 | 這條停了代表什麼 |
|---|---|---|---|
| 有跑班（`_probe/`） | 2026-08-11 | 0 天 | 排程死了 |
| 有抓到東西（`_corpus/`） | 2026-08-11 | 0 天 | 鏈在跑但瞎了（來源全壞、或全站沒更新） |
...
近 30 天（實有語料 19 天）。「沉默過久」是拿**每條實體自己的觀察期**判的（底下來源最早開始被觀察那天起算），不是拿語料庫長度——見 `references/health-alarms.md`。
...
| Safe Superintelligence | 0 | 2 | 0 | 0 | 14d 前 ○ 已知未覆蓋（不觸警） |
| Thinking Machines Lab | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Cohere | 0 | 14 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Perplexity | 0 | 7 | 0 | 0 | 1d 前 ○ 已知未覆蓋（不觸警） |
| Anysphere (Cursor) | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Cognition | 0 | 2 | 0 | 0 | 15d 前 ○ 已知未覆蓋（不觸警） |
| Scale AI | 0 | 144 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Z.ai | 0 | 1 | 0 | 0 | 6d 前 ○ 已知未覆蓋（不觸警） |
| Moonshot AI | 0 | 5 | 0 | 0 | 8d 前 ○ 已知未覆蓋（不觸警） |
| MiniMax | 0 | 38 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| ByteDance | 0 | 2 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Baidu | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Tencent | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| AMD | 1 | 29 | 1 | 0 | 0d 前 |
| TSMC | 0 | 1 | 0 | 0 | 16d 前 ○ 已知未覆蓋（不觸警） |
| Broadcom | 0 | 6 | 0 | 0 | 12d 前 ○ 已知未覆蓋（不觸警） |
