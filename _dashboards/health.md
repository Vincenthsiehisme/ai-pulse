...
probe_lag_days: 0
last_run_day: "2026-09-04"
run_lag_days: 0
stale_after_days: 2
sources_runnable: 28
items_observed: 2696
events_total: 259
events_published: 222
---
...
> 這頁自己就是死人開關：鏈沒跑就沒人重寫它，`generated_day` 會停在 2026-09-04 不動。所以先看那個日期是不是今天，再看下面的燈。
...
| 已觀測 | 累計 2696 筆，來自 25 條來源 | 這裡是**歷來**累計，含現在已停用的來源，所以不能直接跟上一格相減。本窗口誰零產出看下面「覆蓋範圍」那一節 |
| 有效產出 | 259 則事件 | 抓到了但沒聚成事件＝聚類沒認出來 |
| 已發布 | 222 則 | 卡在門禁是設計，不是故障 |

## 鏈的兩條時間軸

| | 最後一次 | 距今 | 這條停了代表什麼 |
|---|---|---|---|
| 有跑班（`_probe/`） | 2026-09-04 | 0 天 | 排程死了 |
| 有抓到東西（`_corpus/`） | 2026-09-04 | 0 天 | 鏈在跑但瞎了（來源全壞、或全站沒更新） |

「靜默死掉」與「靜默瞎掉」是兩種病，所以兩條軸分開印。2026-07-24 漏抓 Claude Opus 5 的那晚，上面那條是綠的。

## 佇列

- 已上線 **222**／review **35**（待處理 20、設計上擋著 15）／人工判定不追 **2**
- 未 enrich **3** 則，最久放了 **35** 天
- 待處理卡最久 **36** 天（天數＝**進庫**多久，不是新聞發布多久）
...
|---|---|---|---|---|---|
| OpenAI | 2 | 1122 | 51 | 49 | 0d 前 |
| Anthropic | 1 | 425 | 32 | 31 | 0d 前 |
| Google DeepMind | 1 | 171 | 10 | 9 | 0d 前 |
| Google | 1 | 456 | 10 | 9 | 0d 前 |
| Meta | 1 | 233 | 1 | 1 | 0d 前 |
| Microsoft | 1 | 125 | 2 | 2 | 0d 前 |
| NVIDIA | 1 | 440 | 23 | 22 | 0d 前 |
| Hugging Face | 1 | 160 | 12 | 8 | 0d 前 |
| xAI | 1 | 13 | 8 | 8 | 0d 前 |
| Mistral AI | 1 | 2 | 0 | 0 | 2d 前 |
| Alibaba | 1 | 9 | 0 | 0 | 11d 前 |
| DeepSeek | 0 | 235 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Safe Superintelligence | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Thinking Machines Lab | 0 | 3 | 0 | 0 | 5d 前 ○ 已知未覆蓋（不觸警） |
| Cohere | 0 | 26 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Perplexity | 0 | 6 | 0 | 0 | 2d 前 ○ 已知未覆蓋（不觸警） |
| Anysphere (Cursor) | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Cognition | 0 | 6 | 0 | 0 | 14d 前 ○ 已知未覆蓋（不觸警） |
| Scale AI | 0 | 235 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Z.ai | 0 | 8 | 0 | 0 | 7d 前 ○ 已知未覆蓋（不觸警） |
| Moonshot AI | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| MiniMax | 0 | 53 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| ByteDance | 0 | 8 | 0 | 0 | 18d 前 ○ 已知未覆蓋（不觸警） |
| Baidu | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Tencent | 0 | 6 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| AMD | 1 | 45 | 0 | 0 | 0d 前 |
| TSMC | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Broadcom | 0 | 0 | 0 | 0 | **從未** ○ 已知未覆蓋（不觸警） |
| Groq | 0 | 13 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| Cerebras | 0 | 24 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
| CoreWeave | 0 | 2 | 0 | 0 | 25d 前 ○ 已知未覆蓋（不觸警） |
| AWS | 0 | 79 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
...
- 判斷層帳本：156 筆，最近一次 2026-09-03（1 天前）；最近 7 天有 6 條主線改過主張（agent-refactor、capital-evolution、global-map、infra-cost、model-research、product-market）
