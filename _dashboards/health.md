...
| 已觀測 | 累計 573 筆，來自 25 條來源 | 這裡是**歷來**累計，含現在已停用的來源，所以不能直接跟上一格相減。本窗口誰零產出看下面「覆蓋範圍」那一節 |
...
| Google | 1 | 58 | 5 | 3 | 0d 前 |
| Meta | 1 | 20 | 0 | 0 | 0d 前 |
| Microsoft | 1 | 19 | 0 | 0 | 0d 前 |
| NVIDIA | 1 | 58 | 16 | 12 | 0d 前 |
| Hugging Face | 1 | 41 | 1 | 1 | 0d 前 |
| xAI | 1 | 5 | 2 | 2 | 0d 前 |
...
| Moonshot AI | 0 | 2 | 0 | 0 | 0d 前 ○ 已知未覆蓋（不觸警） |
