...
目前活躍來源 0 條。來源數少時「跨 ≥2 來源」門檻結構上難以成立，
...
| src-anthropic-news | official | robots_unknown | 0 | 0 |  | False | robots.txt 回 401/403，取不到內容，保守跳過（非站方拒絕） |
...
| src-msr-blog | official | robots_unknown | 0 | 0 |  | None | robots.txt 取不到，保守跳過 |
