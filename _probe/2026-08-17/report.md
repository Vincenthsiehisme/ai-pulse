...
|---|---|---|---|---|
| aggregator | 30 | 30/30 = 100% | 0/30 = 0% | 5/30 = 17% |
| kol | 110 | 70/110 = 64% | 60/110 = 55% | 40/110 = 36% |
| media | 87 | 87/87 = 100% | 78/87 = 90% | 42/87 = 48% |
| official | 198 | 28/198 = 14% | 23/198 = 12% | 146/198 = 74% |
...
| Yunfei Ge, Anbang Liu, Qineng Wang, Johnalbert Garnica, Ziha | multi_person | src-msr-blog |
| michael.nunez@venturebeat.com (Michael Nuñez) | handle | src-media-venturebeat |
| Tim De Chant | person | src-media-techcrunch |
| Theresa Loconsolo, Kirsten Korosec, Anthony Ha, Rebecca Bell | multi_person | src-media-techcrunch |
| Andrej Zdravkovic | person | src-media-ieee-spectrum |
| Voxel51 | handle | src-media-ieee-spectrum |
...
| George Hammond, Financial Times | multi_person | src-media-arstechnica |
...
| src-openai-blog | official | 200 | 50 | 3 |  | True |  |
| src-anthropic-news | official | 200 | 40 | 0 |  | True |  |
| src-gh-vllm-releases | official | 200 | 0 | 0 |  | None |  |
...
| src-media-techcrunch | media | 200 | 20 | 5 |  | True |  |
| src-media-ieee-spectrum | media | 200 | 20 | 2 |  | True |  |
...
| src-kol-simonwillison | kol | 200 | 20 | 3 |  | True |  |
...
| src-hn-frontpage | aggregator | 200 | 30 | 27 |  | True |  |
...
| source | 判定 | 是誰那邊 | 說明 |
|---|---|---|---|
| src-gh-vllm-releases | `source_empty` | 站方 | GitHub API 回 200，這個 repo 目前沒有 release（站方那邊） |
...
- `src-gh-vllm-releases`：kind=None；過濾前 None 條 URL、url_prefix `（無）`、過濾後 None 條
