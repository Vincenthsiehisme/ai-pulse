---
id: "src-kol-oneusefulthing"
type: "source"
owner: "Ethan Mollick"
media_group: "One Useful Thing"
person_id: "person-ethan-mollick"
track: "kol"
tier: 2
role: "expert"
...
# Ethan Mollick（src-kol-oneusefulthing）
...
> 媒體集團：**One Useful Thing**。獨立性是按 source + author + media group 判的，所以同一個 media_group 的兩條來源**加起來只算一個獨立聲音**。
