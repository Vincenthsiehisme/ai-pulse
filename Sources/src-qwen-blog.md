...
id: "src-qwen-blog"
type: "source"
owner: "Alibaba (Qwen Team)"
media_group: "Alibaba-Qwen"
track: "official"
tier: 1
role: "official"
...
|---|---|---|
| 收錄 | `probing` | 會被抓 |
| 已觀測 | 30 筆 | 抓不到，或站方那陣子沒發東西 |
| 有效產出 | 0 則事件 | 抓到了但聚類沒把它綁成證據 |
| 已發布 | 0 則 | 綁上了但門禁擋著——那是設計，不是故障 |

> 媒體集團：**Alibaba-Qwen**。獨立性是按 source + author + media group 判的，所以同一個 media_group 的兩條來源**加起來只算一個獨立聲音**。
