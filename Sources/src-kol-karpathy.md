...
media_group: "Karpathy Blog"
person_id: "person-andrej-karpathy"
track: "kol"
tier: 2
role: "expert"
...
# Andrej Karpathy（src-kol-karpathy）
...
> 媒體集團：**Karpathy Blog**。獨立性是按 source + author + media group 判的，所以同一個 media_group 的兩條來源**加起來只算一個獨立聲音**。
